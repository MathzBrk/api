...
class ConsultaControllerTest {
    ...
    void agendarCenario2() throws Exception {
        ...
        var dadosListagem = new DadosListagemConsulta(null, 2L, 5L, data);

        when(agenda.agendar(any())).thenReturn(dadosListagem);
        ...
        var jsonEsperado = dadosListagemConsultaJson.write(
                dadosListagem
        ).getJson();
